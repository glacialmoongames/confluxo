...
- **Versão atual exibida:** 244, em `index.html`. Revisão visual em `styles-identity.css`; decisões e referências em `DESIGN.md`. Log estruturado em `renderLogEntry`, sem mudar regras.
