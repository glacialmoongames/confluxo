...
assert.match(page, /engine-actions-a\.js\?v=29/);
assert.match(page, /VERSÃO 164/);
...
assert.match(page, /styles-responsive\.css\?v=41/);
...
assert.match(styles, /\.art-crop\.xadria-white-art\{background:[^}]+#c9a0e3[^}]+#9362b8/);
assert.match(styles, /\.art-crop\.xadria-black-art\{background:[^}]+#63357b[^}]+#321642/);
assert.match(styles, /\.board \.piece:not\(\.fusion\) \.board-art\.xadria-white-art\{background:#a875ca!important\}/, 'Casa Branca deve usar roxo claro no campo');
assert.match(styles, /\.board \.piece:not\(\.fusion\) \.board-art\.xadria-black-art\{background:#48235d!important\}/, 'Casa Preta deve usar roxo escuro no campo');
assert.match(styles, /\.board \.piece:not\(\.fusion\) \.board-art\.xadria-black-art img\{filter:brightness\(0\) drop-shadow\(0 0 2px #f3dcff\)!important\}/);
...
assert.match(styles, /\.board \.piece:not\(\.fusion\)\.deck-xadria\{background:#693b82\}/);
...
assert.match(styles, /\.reserve-piece:not\(\.fusion-card\)\.deck-xadria\{background:#693b82\}/);
