...
assert.match(page, /styles-core\.css\?v=4/);
...
assert.match(styles, /\.art-crop\.xadria-white-art\{background:[^}]+#1c121c/);
assert.match(styles, /\.art-crop\.xadria-black-art\{background:[^}]+#ffffff/);
...
assert.match(page, /network\.js\?v=35/);
assert.match(page, /styles-game\.css\?v=9/);
