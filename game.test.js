...
assert.match(page, /network\.js\?v=48/);
assert.match(page, /engine-ui\.js\?v=59/);
...
assert.match(page, /styles-responsive\.css\?v=83/);
...
assert.match(page,/id="match-room-code" class="match-room-code hidden"/,'o cabeçalho deve reservar um indicador para o código online');
