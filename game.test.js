...
assert.match(page, /styles-responsive\.css\?v=53/);
...
assert.match(styles,/\.board\[data-arena=none\] \.cell\.light\{background:#d8d0bf\}\.board\[data-arena=none\] \.cell\.dark\{background:#756b78\}/,'sem Arena, as casas devem recuperar o fundo neutro sob a camada translúcida');
