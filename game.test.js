...
assert.match(page, /styles-responsive\.css\?v=50/);
...
assert.match(styles,/:root\{--arc-xadria-zone-overlay:hsl\(285 72% 48%\/42%\);[^}]+--arc-gold-zone-overlay:/,'todas as zonas devem usar uma camada saturada e translúcida');
