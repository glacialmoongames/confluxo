...
assert.match(page, /engine-actions-a\.js\?v=9/);
assert.match(page, /engine-actions-b\.js\?v=5/);
assert.match(page, /styles-responsive\.css\?v=4/);
...
assert.match(source, /classList\.toggle\('same-deck',sameDeck\)/);
assert.match(styles, /board\.same-deck \.piece\.p1/);
assert.match(styles, /board\.same-deck \.piece\.p2/);
assert.match(styles, /content:"J1"/);
assert.match(styles, /content:"J2"/);
