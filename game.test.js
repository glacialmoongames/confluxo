...
assert.match(page, /engine-actions-b\.js\?v=34/);
assert.match(page, /engine-actions-a\.js\?v=43/);
assert.match(page, /VERSÃO 240/);
...
assert.match(page, /network\.js\?v=49/);
assert.match(page, /engine-ui\.js\?v=60/);
...
assert.match(page, /engine-core\.js\?v=36/);
