...
assert.match(page, /engine-actions-b\.js\?v=28/);
assert.match(page, /engine-actions-a\.js\?v=36/);
assert.match(page, /VERSÃO 209/);
...
assert.match(page, /network\.js\?v=44/);
assert.match(page, /engine-ui\.js\?v=50/);
...
assert.match(page, /styles-responsive\.css\?v=69/);
