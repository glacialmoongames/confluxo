...
assert.match(page, /engine-actions-a\.js\?v=40/);
assert.match(page, /VERSÃO 218/);
...
assert.match(page, /network\.js\?v=45/);
assert.match(page, /engine-ui\.js\?v=53/);
...
assert.match(page, /styles-responsive\.css\?v=73/);
...
assert.match(page, /engine-actions-a\.js\?v=40/);
assert.match(page, /engine-actions-b\.js\?v=32/);
assert.match(page, /i18n\.js\?v=12/);
