...
assert.match(page, /engine-actions-a\.js\?v=31/);
assert.match(page, /VERSÃO 173/);
...
assert.match(page, /network\.js\?v=37/);
assert.match(page, /engine-ui\.js\?v=45/);
...
assert.match(page, /network\.js\?v=37/);
assert.match(page, /styles-game\.css\?v=13/);
