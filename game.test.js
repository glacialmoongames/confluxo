...
assert.match(page, /styles-responsive\.css\?v=23/);
...
assert.match(styles, /effect-hand-panel\{width:calc\(100% \+ 8px\);margin-right:-8px\}/);
assert.match(styles, /reserve-hand-panel\{width:calc\(100% \+ 8px\);margin-left:-8px\}/);
assert.match(styles, /clamp\(150px,12vw,190px\)/);
assert.match(styles, /clamp\(140px,11vw,175px\)/);
assert.match(styles, /clamp\(165px,13\.5vw,225px\)/);
