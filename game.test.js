...
assert.match(page, /engine-actions-a\.js\?v=32/);
...
assert.match(page, /network\.js\?v=39/);
assert.match(page, /engine-ui\.js\?v=46/);
...
assert.match(page, /styles-responsive\.css\?v=55/);
