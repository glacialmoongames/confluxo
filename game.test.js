...
assert.match(page, /engine-core\.js\?v=40/);
...
assert.match(source, /visualArchetype=key==='random'\?randomVisualArchetype\(\):key/,'o Aleatório deve sortear uma identidade visual por partida');
