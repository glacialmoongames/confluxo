...
assert.match(source, /Array\.from\(\{length:20\}/, 'os decks de Efeito devem ter 20 cartas');
assert.match(source, /kinds\.length<20/, 'os decks de Peões devem ser completados até 20 cartas');
