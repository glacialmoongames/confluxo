...
Object.assign(defs,{
 ...
 raven:{name:'Corvo da floresta Abissal',atk:150,movement:[[-2,0],[-1,-1],[-1,1],[1,-1],[1,1],[2,0]],types:['TREVAS'],glyph:'⌃',text:'Uma vez por turno, quando qualquer jogador usa um Equipamento, cria uma cópia dessa carta na mão do dono do Corvo.'},
